-- Cloud backup tables for tracker sessions, route locations, and photos.
-- This migration is intentionally standalone so it can be applied directly in Supabase.
